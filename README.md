...
- 📚 **Канал курса:** [Telegram-группа: Новости и полезные материалы](https://t.me/ecology_R)  
- 🗨️ **Группа для общения:** [Telegram-чат: Обсуждения и обмен идеями](https://t.me/ecology_R_chat)
...
1. **Основы программирования на языке R** *(первая цепочка семинаров)*  
   ...
   [Программа первой цепочки ниже](#первая-цепочка-семинаров).

2. **Анализ пространственных данных в R и QGIS** *(в разработке)*  
   Какие модули включить? Ваши идеи приветствуются! 

3. **Моделирование и статистика в экологии** *(вопрос для обсуждения)*  
